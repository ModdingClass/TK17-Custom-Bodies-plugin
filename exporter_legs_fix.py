...
def export_legs_fix(exportfolderpath, bodyNo):
	...
	snippet = snippet + ".SNode? . {\n";
	snippet = snippet+ "\t.ScalingPivot ("        +" {:.6g}f,".format(generic_x+ 0)    +" {:.6g}f,".format(toe_L_joint.matrix_world.to_translation().z+ 0)    +" {:.6g}f".format(0.1-toe_R_joint.matrix_world.to_translation().y + 0)   +" );\n"   #here we switch to xz -y	
	snippet = snippet+ "\t.RotationPivot ("        +" {:.6g}f,".format(generic_x+ 0)    +" {:.6g}f,".format(toe_L_joint.matrix_world.to_translation().z+ 0)    +" {:.6g}f".format(0.1-toe_R_joint.matrix_world.to_translation().y + 0)   +" );\n"   #here we switch to xz -y	
	snippet = snippet+ "};\n"
	snippet = snippet+""
	legs_fix_string = legs_fix_string+snippet
	legs_fix_string=legs_fix_string + "\n"		
	...
	snippet = snippet + ".SNode? . {\n";
	snippet = snippet+ "\t.ScalingPivot ("        +" {:.6g}f,".format(generic_x+ 0)    +" {:.6g}f,".format(ankle_L_joint.matrix_world.to_translation().z+ 0)    +" {:.6g}f".format(-ball_R_joint.matrix_world.to_translation().y + 0)   +" );\n"   #here we switch to xz -y	
	snippet = snippet+ "\t.RotationPivot ("        +" {:.6g}f,".format(generic_x+ 0)    +" {:.6g}f,".format(ankle_L_joint.matrix_world.to_translation().z+ 0)    +" {:.6g}f".format(-ball_R_joint.matrix_world.to_translation().y + 0)   +" );\n"   #here we switch to xz -y	
	snippet = snippet+ "};\n"
	snippet = snippet+""
	legs_fix_string = legs_fix_string+snippet
	legs_fix_string=legs_fix_string + "\n"		
